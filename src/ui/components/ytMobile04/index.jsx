    ...
    <>
      <VideoContainer className="video-Container" >
        ...
        {isLoading === true ? (
          ...
          (
            <div style={{ pointerEvents: stateActive === true ? "auto" : "none" }}>
        ...
        <ControlsContainer togglePlay={togglePlay.playVideo} style={{ pointerEvents: stateActive === true ? "auto" : "none" }}>
          <ProgressBarContainer className={`${stateActive === true ? "activeProgress" : "disable"}`}
            onTouchStart={startDragging}
            onTouchMove={handleDrag}
            onTouchEnd={stopDragging}
          >
            <ProgressBar ref={progressBarRef} className="progress-bar">
          ...
          <Controls className={`${stateActive === true ? "activeProgress" : "disable"}`} draggable="false" togglePlay={togglePlay}>
